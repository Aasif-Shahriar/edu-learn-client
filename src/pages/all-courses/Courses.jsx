...
const Courses = () => {
  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900">
      <div className="max-w-[1560px] mx-auto px-4 py-10 space-y-8  transition-colors duration-300">
        <title>Courses - EduLearn</title>

        {/* Header */}
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-3 text-gray-800 dark:text-white transition-colors duration-300">
            Explore All Courses
          </h1>
            ...
            <div className="flex items-center gap-2">
              ...
              {isFilterActive && (
                <button
                  ...
                  className="flex items-center gap-1 text-sm bg-red-100 text-red-700 hover:bg-red-200 dark:bg-red-900/30 dark:text-red-300 dark:hover:bg-red-800/40 px-3 py-1 rounded-full transition"
                >
          ...
          >
            ...
            <div className="relative order-first md:order-none">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition"
                value={searchQuery}
                onChange={(e) => {
            ...
            {/* Category */}
            <select
              className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white transition"
